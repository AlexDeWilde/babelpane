...
- Current milestone: all 4 original milestones (M1-M4) done and verified, plus settings window + pane-geometry persistence from the brief's Must Demonstrate list, plus post-deliverable multi-monitor support, click-to-trigger/native resize/copy-to-clipboard, a literal/summary translation mode toggle, and a post-demo bug-hunt fixing a silent-timeout bug, a too-tight default timeout, and incomplete OCR on small captures.
